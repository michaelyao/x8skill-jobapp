 ...
 */
const ALLOWED = new Set(["approve", "skip", "manual_submit", "mark_closed", "answer_question", "apply", "change", "retry", "sweep", "refresh_list", "update_answers", "forget_answers", "update_guidelines"]);
...
export async function POST(request: Request): Promise<Response> {
  ...
  const needsCode = ["approve", "skip", "manual_submit", "mark_closed", "answer_question", "apply", "change", "retry"].includes(name);
